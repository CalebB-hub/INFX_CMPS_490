...
""",
    ...
    },
    {
        ...
        "lesson_material": """## Lesson 2: Links, URLs, and Fake Websites
        
Many phishing attacks try to lead people to fake websites that look real. These sites are designed to steal usernames, passwords, payment details, or other personal information. Some fake sites are very convincing and may closely copy the appearance of real login pages.
...
QR codes can also hide dangerous links. They should be treated with the same caution as suspicious URLs. Just because a code is convenient or easy to scan does not mean the destination is safe.""",
    ...
    },
    {
        ...
        "lesson_material": """## Lesson 3: Attachments, Downloads, and What to Do If You Click

Phishing is not only about links. Some phishing attacks use files and downloads to install malware, steal information, or trick users into more risky actions. Attachments can be disguised as invoices, forms, delivery notices, or important work documents.
...
Suspicious emails should usually be reported and deleted instead of replied to or interacted with. Reporting helps the organization or provider detect threats faster and may help protect other users from the same scam.""",
    ...
    },
    {
        ...
        "lesson_material": """## Lesson 4: Targeted Phishing, Smishing, Vishing, and High-Stakes Requests
