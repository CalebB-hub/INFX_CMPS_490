...
# Use DATABASE_URL if set (e.g., for Render Postgres), otherwise fall back to SQLite for local development
DATABASES = {
...
SIMPLE_JWT = {
    ...
    # Leave lifetimes at their defaults; can be tuned later
